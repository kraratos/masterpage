...
export class TopNavbarComponent implements OnInit {
  ...
  viewRangeDatepicker: boolean = false;
  ...
  ngOnInit(): void {
    ...
    // this.dataService.optionsMicroAppLayout.subscribe(pageOptions=>{
    //   //IMPORTANT RESET VALUE
    //     this.hideDateRange = false;
    //     this.disableDateRange = false;
    //     this.disableNavbar = false;
    //     this.viewRangeDatepicker = false;
    //     pageOptions.forEach(pOption => {
    //       switch (pOption.parameterType) {
    //         case 'DISABLE_DATERANGE':
    //           this.disableDateRange = pOption.parameterValue=='Y';
    //           break;
    //         case 'HIDE_DATERANGE':
    //           this.hideDateRange = pOption.parameterValue=='Y';
    //           break;
    //         case 'DISABLE_NAVBAR':
    //           this.disableNavbar = pOption.parameterValue=='Y';
    //           break;
    //         case 'SHOW_DATEPICKER':
    //           this.viewRangeDatepicker = pOption.parameterValue=='Y';
    //           break;
    //       }
    //     })
    // });
