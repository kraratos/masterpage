...
export class DataService {
  ...
  // cancelPendingRequest(uriRequest:string='cp-proxy-data-service/v1/widgetsdata'){
  //   const cachedResponse = this.cache.get(uriRequest);
  //   if (cachedResponse) {
  //     cachedResponse.next();
  //     this.cache.delete(uriRequest);
  //   }
  // }
  // cancelAllPendingRequest(){
  //   this.cache.forEach((cachedResponse, uriRequest) => {
  //     if (cachedResponse) {
  //       cachedResponse.next();
  //       this.cache.delete(uriRequest);
  //     }
